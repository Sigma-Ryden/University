...
# Випишіть у звіт всі 14 ознак з набору даних – їх назви та
# що вони позначають та вид (числові чи категоріальні).
...
# Обчисліть значення інших показників якості класифікації (акуратність, повнота, точність)
# та разом з F1 занесіть їх у звіт. (Див. ЛР-1).
